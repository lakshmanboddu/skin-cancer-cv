...
//        Display.display(src,"Input");
        ...
        imwrite("src/data/grayScaleSample1.jpg", grayScaleImg);
//        Display.display(grayScaleImg, "Gray Scale Image");
        ...
        imwrite("src/data/blackHat-output.jpg", blackHat);
